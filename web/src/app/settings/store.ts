...
function normalizeConfig(config: SettingsConfig): SettingsConfig {
  ...
  return {
    ...
    default_upstream_model_name: String(config.default_upstream_model_name || "gpt-5.6-sol-wm"),
  ...
  saveConfig: async () => {
    ...
    try {
      const data = await updateSettingsConfig({
        ...
        default_upstream_model_name: String(config.default_upstream_model_name || "gpt-5.6-sol-wm").trim() || "gpt-5.6-sol-wm",
