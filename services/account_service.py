...
class AccountService:
    ...
    def _list_ready_candidate_tokens_all(
            self,
            excluded_tokens: set[str] | None = None,
            plan_type: str | None = None,
            source_type: str | None = None,
    ...
    def _acquire_next_candidate_token(
        ...
        with self._image_slot_condition:
            while True:
                if not self._list_ready_candidate_tokens_all(excluded_tokens, plan_type, source_type, plan_types):
                    raise RuntimeError(
                ...
                tokens = self._get_priority_aware_candidates(excluded_tokens, plan_type, source_type, plan_types)
                if tokens:
    ...
    def _get_priority_aware_candidates(
            self,
            excluded_tokens: set[str] | None = None,
            plan_type: str | None = None,
            source_type: str | None = None,
